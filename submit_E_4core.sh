...
echo "START: $(date)"
/usr/bin/time -v /scratch/na00078/conda_envs/QuickCW/bin/python /scratch/na00078/projects/IPTA_MDC2/runQuickMCMC_G2D2_broad.py --save_filename G2D2_broad_detect_tref_4core.h5 --amplitude_prior detection
echo "END: $(date)"
