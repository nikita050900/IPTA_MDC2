...
import QuickCW.QuickCW_targeted_NGC1275_broad as QuickCW
...
savefile = '/scratch/js0311/jet_source_project_results/broad_freq_upperlimit_runs/NGC1275_broad_wJ1713_N1e9_thin10.h5'
#savefile = None
