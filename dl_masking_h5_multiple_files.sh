#!/bin/bash
#SBATCH --job-name=G2D1_narrow_detect_fixed_gamma_17_dec_2025
#SBATCH --output=G2D1_narrow_detect_fixed_gamma_17_dec_2025.out        # unique output per job ID
#SBATCH -p sbs0016
...
declare -a TARGETS=(
"G2D1_narrow_detect_fixed_gamma_17_dec_2025.h5 75.4"
