...
#SBATCH --output=/scratch/na00078/projects/IPTA_MDC2/G2D1_broad_UL_4core.out
#SBATCH -p sbs0016
#SBATCH --mem=64G
#SBATCH --ntasks=1
...
echo "START: $(date)"
/usr/bin/time -v /scratch/na00078/conda_envs/QuickCW/bin/python /scratch/na00078/projects/IPTA_MDC2/runQuickMCMC_G2D1_broad_4core.py --save_filename G2D1_broad_UL_4core.h5 --amplitude_prior UL
echo "END: $(date)"
