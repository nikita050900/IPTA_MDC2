...
#SBATCH --ntasks=1
$PY runQuickMCMC_G2D1_narrow.py --save_filename G2D1_narrow_detect.h5 --amplitude_prior detection
EOF
)
...
#SBATCH --mem-per-cpu=64G
#SBATCH --ntasks=1
$PY runQuickMCMC_G2D1_narrow.py --save_filename G2D1_narrow_UL.h5 --amplitude_prior UL
EOF
