...
# ===========================
# LOAD DATA PKL FROM ENV VAR
# ===========================
data_pkl = os.getenv("DATA_PKL")
if data_pkl is None:
    raise ValueError("ERROR: DATA_PKL environment variable not set.")

print(f"Loading pulsars from: {data_pkl}")
with open(data_pkl, 'rb') as psr_pkl:
    psrs = pickle.load(psr_pkl)
print("Loaded pulsars:", len(psrs))
...
noisefile = '/scratch/na00078/projects/IPTA_MDC2/IPTA_MDC2_data/noise_files/fit_psr_noise_dataset2.json'
